...
export function TesistaActions({ programa, variant = "card", tarifas }: TesistaActionsProps) {
    ...
    const mensajeWhatsApp = `Hola, vengo del Directorio de Posgrados. Me interesa ` +
        `el servicio de redacción de tesis para el programa: ` +
        `${programaTexto} — ` +
        `${programa.universidad}, ${programa.pais}.`;
    const whatsappUrl = `https://wa.me/573005347644?text=${encodeURIComponent(mensajeWhatsApp)}`;
    ...
    return (
        <div className="flex flex-col gap-2 w-full">
            ...
            <a
                ...
                onClick={() => trackEvent("whatsapp_click", { origen: variant, programa: programa.nombre })}
            >
