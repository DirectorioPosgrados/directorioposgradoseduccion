...
export function TesistaActions({ programa, variant = "card" }: TesistaActionsProps) {
    ...
    return (
        <div className="flex flex-col gap-2 w-full">
            ...
            {/* ── Botón WhatsApp "Contactar Asesor" ── */}
            <button
                className={`font-sans text-sm font-semibold no-underline rounded-[4px] flex items-center justify-center gap-1.5 cursor-pointer w-full transition-all text-white bg-[#25D366] border-2 border-[#25D366] hover:bg-[#1ebe5d] hover:border-[#1ebe5d] ${esDetalle ? "px-8 py-4" : "px-3.5 py-2"}`}
